...
/*
    float boxr = 150.0f/255.0, boxg = 160.0f/255.0, boxb = 220.0f/255.0;    
    float w = 20.0f;
    float dir = 25.0f;
...
void X11_wrapper::check_resize(XEvent *e)
{
	...
	if (xce.width != g.xres || xce.height != g.yres) {
        ...
        //attempt at getting box to "dissappear" if window is too small
        /*
        if (xce.height < g.yres) {
            boxr = 0.1, boxg = 0.1, boxb = 0.1;
        }
        */
}
//-----------------------------------------------------------------------------
